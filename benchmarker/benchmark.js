...
const allOps = require('@hiveio/hive-js/lib/auth/serializer').makeBitMaskFilter(
    Array.from(
        Array(
            Object.keys(require('@hiveio/hive-js/lib/auth/serializer/src/ChainTypes').operations).length
        ).keys()
    )
)
